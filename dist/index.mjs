		...
		p(ctx, dirty) {
			if (default_slot) {
				if (default_slot.p && dirty & /*$$scope, field*/ 32776) {
					update_slot(default_slot, default_slot_template, ctx, /*$$scope*/ ctx[15], dirty, get_default_slot_changes_2, get_default_slot_context_2);
				}
			}
		},
		i(local) {
...
function create_if_block_1(ctx) {
	...
	const component_slot = create_slot(component_slot_template, ctx, /*$$scope*/ ctx[15], get_component_slot_context);
		...
		p(ctx, dirty) {
			if (component_slot) {
				if (component_slot.p && dirty & /*$$scope, field*/ 32776) {
					update_slot(component_slot, component_slot_template, ctx, /*$$scope*/ ctx[15], dirty, get_component_slot_changes, get_component_slot_context);
				}
			} else {
...
function create_default_slot(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (default_slot) {
				if (default_slot.p && dirty & /*$$scope, field*/ 32776) {
					update_slot(default_slot, default_slot_template, ctx, /*$$scope*/ ctx[15], dirty, get_default_slot_changes_1, get_default_slot_context_1);
				}
			}
		},
		i(local) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	component_subscribe($$self, fieldStore, value => $$invalidate(16, $fieldStore = value));
